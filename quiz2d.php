...
$user_id = $_SESSION['id'];
$quiz_id = 2; // Thay đổi tương ứng với quiz (1 cho quiz1d, 2 cho quiz2d, ...)
...
<head>
  <title>Quiz</title>
  <link rel="stylesheet" href="quiz2d.css">
...
<body>
  <section id="Question1">
    <div class="Question" style="background-color: springgreen;">
      <div class="box">
        <h2>Theme 4 - Fruits: Can you choose the correct answer?</h2>
  ...
  <section id="Answer1" style="display:none">
    <div class="Answer">
        <div class="item1">
          <h1>Question 4: Is a tomato a fruit?</h1>
    ...
    <div class="Result">
      <div class="R">
        ...
        <script>
            ...
            xhr.open("GET", "update_progress.php?quiz_id=2", true); // Thay đổi quiz_id cho từng trang
            xhr.send();
            });
        </script>
